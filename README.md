...
> **Disclaimer:** The `me/` folder containing personal data (LinkedIn PDF, personal summary, profile picture) is excluded from this repository via `.gitignore` and is not publicly available. It lives only on HuggingFace Spaces as private files. This personal content is the exclusive property of Adel Lis and any reproduction, distribution, or use without explicit written permission is strictly prohibited.
...
Code is freely reusable. Personal content (CV, photo, summary) is not included in this repository and is not licensed for reuse.
